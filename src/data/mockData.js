...
const fetchData = async () => {
  try {
    ...
    recentleadcount = response.data.recentleadcount
...
// console.log("recentleadcount" + recentleadcount.yesterdayLeadsCount)
...
export const last2daysLeads = recentleadcount
...
export const compareBar = monthYearCounts
