...
const Offers = () => {
    ...
    async function fetchData() {
      try {
        ...
        const res = await axios.get(
          "https://nexa-backend-git-main-saboo-nexas-projects.vercel.app/getOffers",
          {
  ...
  const handleDup = async () => {
    try {
      ...
      const res = await axios.get(
        "https://nexa-backend-git-main-saboo-nexas-projects.vercel.app/duplicateOffers",
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const uniqueEntries = async () => {
    try {
      ...
      const res = await axios.get(
        `https://nexa-backend-git-main-saboo-nexas-projects.vercel.app/offersUniqueEntries`,
        {
          headers: { Authorization: `Bearer ${token}` },
        }
      );
  ...
  const handleGetData = async () => {
    ...
    try {
      ...
      res = await axios.post(
        "https://nexa-backend-git-main-saboo-nexas-projects.vercel.app/offersRange",
        {
          startDate: startDate,
          endDate: endDate,
        },
 ...
 return (
  <Box m="20px">
    <Header
  title="Offers"
  subtitle="data from offers page"
